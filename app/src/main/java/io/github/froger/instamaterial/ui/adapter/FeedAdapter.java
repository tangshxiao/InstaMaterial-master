...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void setupClickableViews(final View view, final CellFeedViewHolder cellFeedViewHolder) {
        MyClickLiser myClickLiser = new MyClickLiser(view, cellFeedViewHolder);
        cellFeedViewHolder.btnComments.setOnClickListener( myClickLiser);
        cellFeedViewHolder.btnMore.setOnClickListener(myClickLiser );
        cellFeedViewHolder.ivFeedCenter.setOnClickListener(myClickLiser );
        cellFeedViewHolder.btnLike.setOnClickListener(myClickLiser );
        cellFeedViewHolder.ivUserProfile.setOnClickListener(myClickLiser );
    }

    /**
     * 点击事件
     */
    private class MyClickLiser implements View.OnClickListener {
        private View view;
        private CellFeedViewHolder cellFeedViewHolder;

        MyClickLiser(final View view, final CellFeedViewHolder cellFeedViewHolder) {
            this.view = view;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ivFeedCenter: // 图片
                    ...
                    break;
                case R.id.btnLike: // 心心
                    int adapterPosition1 = cellFeedViewHolder.getAdapterPosition();
                    feedItems.get(adapterPosition1).likesCount++;
                    notifyItemChanged(adapterPosition1, ACTION_LIKE_BUTTON_CLICKED);
                    if (context instanceof MainActivity) {
                        ((MainActivity) context).showLikedSnackbar();
                    }
                    break;
                case R.id.ivUserProfile: // 头像
